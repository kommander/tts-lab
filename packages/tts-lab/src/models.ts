...
export const QWEN_PARAMETER_DEFINITIONS = [
  {
    id: "language",
    label: "Language",
    description: "Auto-detect or force the text language",
    type: "enum",
    default: "auto",
    options: [
  ...
  },
  {
    id: "topP",
    label: "Top P",
    description: "Nucleus sampling breadth; 0.9 to 0.95 is more selective",
    type: "number",
    default: 1,
    min: 0.1,
    max: 1,
  ...
  },
  {
    id: "topK",
    label: "Top K",
    description: "Maximum candidate tokens considered per generation step",
    type: "number",
    default: 50,
    min: 1,
    max: 100,
  ...
  },
  {
    ...
    description: "Discourages repeated audio-token patterns",
    type: "number",
    default: 1.05,
    min: 1,
    max: 1.5,
  ...
  },
  {
    id: "seed",
    label: "Seed",
    description: "Reproduces one sampling path; no seed is universally best",
    type: "number",
    default: 42,
    min: 0,
    max: 2147483647,
